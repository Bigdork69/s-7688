        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS MYRIAD?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-2" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">HAS RUG RADIO CLOSED?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-3" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS $RUG, DO I NEED TO CLAIM IT?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-4" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS ABSTRACT</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-5" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS $MYR</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-6" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS THE MYRIAD FOUNDATION</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-7" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT IS DASTAN</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-8" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WILL FOW3 AND MEMBERSHIP PASS PLAY ANY ROLE IN MYRIAD</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-9" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT ROLE WILL RUG RADIO GENESIS PASS PLAY IN MYRIAD</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-10" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT ARE MYRIAD POINTS USED FOR</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-11" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHEN TGE?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-12" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WILL MY $RUG BE CONVERTED TO $MYR?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-13" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHAT HAPPENED TO THE DAO?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-14" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">CAN I BUY $RUG DIRECTLY AND JUST CONVERT THAT?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-15" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">DOES MYRIAD HAVE A HOW-TO GUIDE?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-16" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">WHERE CAN I BUY RUG RADIO RELATED NFTS?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-17" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">HOW CAN I WORK WITH OR PARTNER WITH MYRIAD OR DECRYPT?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-18" className="bg-white rounded-lg px-6">
              <AccordionTrigger className="text-lg font-medium text-left md:text-center">I CAN'T LOG IN, MY POINTS DON'T WORK, MY ACCOUNT IS NOT RESPONDING.</AccordionTrigger>
              <AccordionContent>
